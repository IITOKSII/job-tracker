...
- [x] **Skill Internalization** — .agents/skills/ and .claude/skills/ scanned: firebase-agent-skills.md (Firestore Compat v10.12.2, triple-guarded storage), vercel-ai.md (Next.js/AI SDK, edge runtime), engineering-rules.md (sync.ps1, A11y priority, Claude executes/Gemini manages) (2026-03-15, optimistic-babbage)
